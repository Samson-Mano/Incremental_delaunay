...
                {
        ...
        private void button_delaunay_Click(object sender, EventArgs e)
        {
           ...
           //  delaunay_triangulation_divide_n_conquer.delaunay_start(main_drw_obj.all_points, ref temp_edges, ref temp_faces, ref temp_instances);

            // Delaunay Triangulation incremental algorithm
            delaunay_triangulation_incremental.delaunay_start(main_drw_obj.all_points, ref temp_edges, ref temp_faces, ref temp_instances);
